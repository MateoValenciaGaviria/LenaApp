...
public class HTTPSWebUtilDomi {
    ...
    public String POSTtoFCM(String json) {
        try {
            ...
            connection.setRequestProperty("Authorization", "key=AAAARkmKpa4:APA91bG_9FVjGjvIOBT0Qm4mjx8Gaf4cTc7VuVAneAtS9k_cCveOeIj3GXGbu-a05Z_CKQHcAejbc3Pd3nM_ixCfBpmMx_Erqf-Pa6ZX_LfGDsv-g7EVyDKk3OeumSGJEzaM6T0bTzBl");
